...
const Experience = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto py-10 px-4 space-y-8 text-white">
      <section className="bg-zinc-800 p-5 sm:p-8 md:p-12">
      ...
      <section className="bg-zinc-700 p-5 sm:p-8 md:p-12">
